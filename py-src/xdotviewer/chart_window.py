...
from ros_element import ElementReference, ElementType, NodeType, ChartRequest, ChartType, ChartValue
...
class ChartWindow(Gtk.Window):
    def __init__(self, r2ta: R2TAInterface, element: ElementReference):
        ...
        scatter_icon = Gtk.Image.new_from_file(os.path.join(pathlib.Path(__file__).parent.resolve(), "media", "scatter.png"))
        ...
        histogram_icon = Gtk.Image.new_from_file(os.path.join(pathlib.Path(__file__).parent.resolve(), "media", "histogram.png"))
    ...
    def render(self):
        return self.r2ta.render(ChartRequest(
